...
export const ProductModal = ({ isOpen, onClose, editingProduct = null }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editingProduct) {
      if (!await updateProduct(editingProduct.id, {
        ...formData,
        imageUrl: defaultImg
      })) return;
    } else {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-[#0F172A]/60 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6 text-[#0F172A]">
      <div className="relative w-full max-w-3xl bg-white border border-[#E7D9B5] rounded-3xl shadow-2xl overflow-hidden animate-fade-in flex flex-col max-h-[90vh]">
        {/* Modal Header */}
        <div className="p-6 border-b border-[#E7D9B5] bg-white flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-[#FFFDF5] border border-[#DCC78B] flex items-center justify-center text-[#D4A017]">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6 text-xs">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] placeholder-stone-400 focus:outline-none focus:border-[#A87A00] font-medium"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] placeholder-stone-400 focus:outline-none focus:border-[#A87A00]"
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 bg-white border border-[#E7D9B5] rounded-2xl text-emerald-800 font-mono font-bold focus:outline-none focus:border-[#A87A00]"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white border border-[#E7D9B5] rounded-2xl text-[#374151] font-mono focus:outline-none focus:border-[#A87A00]"
                />
              </div>
            </div>

            <div className="flex items-center justify-between pt-2 border-t border-[#E7D9B5]">
              <div>
          ...
          <div className="p-4 rounded-3xl bg-white border border-[#E7D9B5] space-y-3 shadow-xs">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1 rounded-xl bg-[#FFFDF5] hover:bg-[#F8E8BD] text-[#6B4D00] font-bold text-[11px] border border-[#DCC78B] transition"
              >
              ...
              {formData.variants.map((variant, idx) => (
                <div key={idx} className="flex items-center gap-2">
                  <input
                    ...
                    className="w-1/3 px-3 py-2 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] focus:outline-none focus:border-[#A87A00]"
                  />
                  <input
                    type="text"
                    value={variant.value}
                    ...
                    className="flex-1 px-3 py-2 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] focus:outline-none focus:border-[#A87A00]"
                  />
                  <button
                    type="button"
                    onClick={() => removeVariantRow(idx)}
                    className="p-2 rounded-2xl bg-white hover:bg-rose-100 text-slate-400 hover:text-rose-600 border border-[#E7D9B5] transition"
                  >
          ...
          <div className="space-y-2">
            ...
            <div className="p-4 rounded-3xl border-2 border-dashed border-[#E7D9B5] bg-[#FFFDF5]/50 hover:border-[#A87A00] transition flex flex-col items-center justify-center text-center space-y-2">
              ...
              <input
                ...
                className="w-full max-w-md px-3 py-1.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] text-[11px] focus:outline-none focus:border-[#A87A00]"
              />
            </div>
          </div>
          ...
          {/* Action Buttons */}
          <div className="pt-4 border-t border-[#E7D9B5] flex items-center justify-end gap-3">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2.5 rounded-2xl bg-white hover:bg-[#FFF3CE] border border-[#E7D9B5] text-[#6B4D00] font-bold transition"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-6 py-2.5 rounded-2xl bg-[#D4A017] hover:bg-[#6B4D00] text-white font-bold shadow-xs transition"
            >
