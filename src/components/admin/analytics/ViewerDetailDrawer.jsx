        ...
        <div className="p-6 border-b border-[#E7D9B5] bg-white flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            <img
              ...
              alt={product.name}
              className="w-12 h-12 rounded-2xl object-cover border border-[#E7D9B5] bg-white shrink-0"
            />
            <div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-xs">
          ...
          <div className="p-5 rounded-3xl bg-white border border-[#E7D9B5] space-y-3 shadow-xs">
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-white h-2 rounded-full overflow-hidden flex border border-[#E7D9B5]">
          ...
          <div className="p-5 rounded-3xl bg-white border border-[#E7D9B5] space-y-3 shadow-xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="p-3.5 rounded-2xl bg-white border border-[#E7D9B5] space-y-1">
            ...
            <div className="divide-y divide-[#E7D9B5]/60">
              {product.recentViewLogs.map((log, idx) => (
                <div key={idx} className="py-3 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-xl bg-white border border-[#E7D9B5]">
