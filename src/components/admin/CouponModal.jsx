...
export const CouponModal = ({ isOpen, onClose, coupon = null, onSaved }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0F172A]/60 backdrop-blur-sm">
      <div className="relative w-full max-w-lg rounded-3xl border border-[#E7D9B5] bg-white shadow-2xl p-6 sm:p-8 space-y-6 max-h-[90vh] overflow-y-auto text-[#0F172A] animate-fade-in">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#E7D9B5] pb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-[#FFFDF5] border border-[#DCC78B] flex items-center justify-center">
          ...
          <button
            onClick={onClose}
            className="p-2 text-slate-400 hover:text-slate-600 rounded-xl hover:bg-[#FFF3CE] transition"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#8A6200] font-mono text-sm font-bold placeholder:text-slate-400 focus:outline-none focus:border-[#A87A00] uppercase"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] text-xs placeholder:text-slate-400 focus:outline-none focus:border-[#A87A00]"
            />
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 p-1 rounded-2xl bg-white border border-[#E7D9B5]">
              <button
                type="button"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] text-xs placeholder:text-slate-400 focus:outline-none focus:border-[#A87A00] font-bold"
              />
            </div>
            ...
            <div className={discountType !== 'PERCENT' ? 'sm:col-span-2' : ''}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] text-xs placeholder:text-slate-400 focus:outline-none focus:border-[#A87A00]"
                />
              </div>
            </div>
          </div>
          ...
          <div className="pt-2">
            <label className="flex items-center gap-3 cursor-pointer p-3 rounded-2xl bg-white border border-[#E7D9B5]">
              <input
                type="checkbox"
                checked={isActive}
                onChange={(e) => setIsActive(e.target.checked)}
                className="w-4 h-4 rounded text-[#8A6200] focus:ring-[#A87A00]"
              />
          ...
          <div className="pt-4 border-t border-[#E7D9B5] flex items-center justify-end gap-3">
            <button
              type="button"
              onClick={onClose}
              className="py-2.5 px-4 rounded-2xl text-xs font-semibold text-[#6B4D00] hover:bg-[#FFF3CE] transition"
            >
              Cancel
            </button>
            <button
              ...
              className="py-2.5 px-6 rounded-2xl bg-[#8A6200] hover:bg-[#6B4D00] text-white font-bold text-xs shadow-xs flex items-center gap-2 transition disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
