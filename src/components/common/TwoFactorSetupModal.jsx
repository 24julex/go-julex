  ...
  <div>
    ...
    <div className="flex gap-2">
      <input
        ...
        inputMode="numeric"
        autoFocus
        className="w-full px-3 py-2.5 rounded-xl text-sm bg-white text-slate-900 font-mono font-bold tracking-[0.3em] focus:outline-none focus:border-[#8A6200] border"
      />
      <button
        onClick={onSubmit}
        disabled={busy}
