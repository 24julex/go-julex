          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <img
                ...
                alt="Avatar Preview"
                className="w-14 h-14 rounded-2xl object-cover border-2 border-[#A87A00] shadow-sm"
              />
              <div className="flex-1 space-y-2">
                <input
                  ...
                  className="w-full px-3 py-1.5 rounded-xl border border-[#E7D9B5] text-xs focus:ring-2 focus:ring-[#8A6200]/20 focus:outline-none"
                />
                    ...
                    <button
                      ...
                      className={`text-[10px] px-2 py-0.5 rounded-lg border transition ${
                        formData.avatarUrl === p.url
                          ? 'bg-[#8A6200] text-white border-[#8A6200] font-bold'
                          : 'bg-[#FFFDF5] text-[#6B4D00] border-[#DCC78B] hover:bg-[#FFF3CE]'
                      }`}
                    >
                      {p.label}
                    </button>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-[#E7D9B5] text-xs font-medium text-[#0F172A] focus:ring-2 focus:ring-[#8A6200]/20 focus:border-[#8A6200] focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2.5 rounded-xl border border-[#E7D9B5] text-xs font-medium text-[#0F172A] focus:ring-2 focus:ring-[#8A6200]/20 focus:border-[#8A6200] focus:outline-none"
              />
            </div>
          </div>
