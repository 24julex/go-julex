...
export const AdminCustomers = () => {
  const { currentStore, addCustomer } = useMerchantAdmin();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          disabled
          title="Customers appear automatically after real store orders"
        ...
        >
          <Plus className="w-4 h-4 stroke-[3]" /> Customers appear after orders
        </button>
      </div>
