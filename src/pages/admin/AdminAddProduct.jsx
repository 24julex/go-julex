...
export const AdminAddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (existingProduct) {
      if (!await updateProduct(existingProduct.id, payload)) return;
    } else {
      if (!await addProduct(payload)) return;
    }
    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-16 text-[#0F172A]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-[#E7D9B5] pb-4">
        <div className="flex items-center gap-3">
          <Link
            to="/admin/products"
            className="p-2 rounded-2xl bg-white border border-[#E7D9B5] hover:bg-[#FFF3CE] text-[#6B4D00] hover:text-[#0F172A] transition"
          >
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/admin/products"
            className="px-4 py-2 rounded-2xl bg-white hover:bg-[#FFF3CE] border border-[#E7D9B5] text-xs font-bold text-[#6B4D00] transition"
          >
            Cancel
          </Link>
          <button
            ...
            className="px-6 py-2 rounded-2xl bg-[#8A6200] hover:bg-[#6B4D00] text-white font-bold text-xs shadow-xs transition transform active:scale-95"
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#E7D9B5] space-y-4 shadow-xs">
          <div className="flex items-center justify-between border-b border-[#E7D9B5] pb-3">
            <h2 className="text-sm font-bold text-[#0F172A] font-serif flex items-center gap-2">
              <FileText className="w-4 h-4 text-[#8A6200]" /> 1. Basic Information
            </h2>
            <span className="text-[10px] text-[#6B4D00] uppercase tracking-wider font-semibold">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] placeholder-stone-400 focus:outline-none focus:border-[#A87A00] text-sm font-medium"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] placeholder-stone-400 focus:outline-none focus:border-[#A87A00] leading-relaxed font-sans"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] focus:outline-none focus:border-[#A87A00] font-medium"
                >
                ...
                {showCustomCatInput && (
                  <input
                    ...
                    className="w-full mt-2 px-3.5 py-2 bg-white border border-[#A87A00] rounded-2xl text-[#0F172A] placeholder-stone-400 focus:outline-none focus:border-[#A87A00]"
                  />
                )}
              </div>
                  ...
                  {(CATEGORY_SUBCATEGORIES_MAP[category] || []).slice(0, 6).map((sub) => (
                    <button
                      ...
                      className={`px-2 py-0.5 rounded-lg text-[10px] font-semibold transition ${
                        productType === sub
                          ? 'bg-[#8A6200] text-white'
                          : 'bg-[#FFFDF5] text-[#6B4D00] hover:bg-[#FFF3CE] border border-[#DCC78B]'
                      }`}
                    >
                      {sub}
                    </button>
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#E7D9B5] space-y-4 shadow-xs">
          ...
          <div className="space-y-4 text-xs">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="84500"
                    required
                    className="w-full pl-8 pr-3 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-emerald-800 font-mono font-bold text-sm focus:outline-none focus:border-[#A87A00]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="98000"
                    className="w-full pl-8 pr-3 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#6B4D00] font-mono focus:outline-none focus:border-[#A87A00]"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-3xl bg-white border border-[#E7D9B5] space-y-3">
              <div className="flex items-center justify-between">
                <div>
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full transition-colors flex items-center p-0.5 ${
                    chargeTax ? 'bg-[#8A6200] justify-end' : 'bg-stone-300 justify-start'
                  }`}
                >
              ...
              {chargeTax && (
                <div className="pt-2 border-t border-[#E7D9B5] flex items-center gap-3 animate-fade-in">
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-1 rounded-xl font-mono font-bold text-xs transition ${
                            gstRatePercent === num
                              ? 'bg-[#8A6200] text-white shadow-xs'
                              : 'bg-white border border-[#E7D9B5] text-[#6B4D00] hover:bg-[#FFF3CE]'
                          }`}
                        >
                          {rate}
                        </button>
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#E7D9B5] space-y-4 shadow-xs">
          <div className="flex items-center justify-between border-b border-[#E7D9B5] pb-3">
            <h2 className="text-sm font-bold text-[#0F172A] font-serif flex items-center gap-2">
              <Upload className="w-4 h-4 text-[#8A6200]" /> 3. Universal Media Uploader
            </h2>
          ...
          <div className="space-y-4 text-xs">
            ...
            <label className="cursor-pointer p-6 rounded-3xl border-2 border-dashed border-[#E7D9B5] hover:border-[#A87A00] bg-[#FFFDF5]/60 flex flex-col items-center justify-center text-center space-y-2 transition block">
              <input
                type="file"
                accept="image/*"
                multiple
              ...
              />
              <div className="w-12 h-12 rounded-2xl bg-[#FFFDF5] border border-[#DCC78B] flex items-center justify-center text-[#8A6200]">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3.5 py-2 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] placeholder-stone-400 focus:outline-none focus:border-[#A87A00] font-mono text-[11px]"
              />
              <button
                type="button"
                onClick={handleAddMediaUrl}
                className="px-4 py-2 rounded-2xl bg-[#FFFDF5] hover:bg-[#F8E8BD] border border-[#DCC78B] text-[#6B4D00] font-bold transition whitespace-nowrap"
              >
                + Add URL
              </button>
            </div>
            ...
            {mediaList.length > 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-3 pt-2">
                {mediaList.map((media, idx) => (
                  <div
                    key={media.id}
                    className="relative group rounded-2xl overflow-hidden border border-[#E7D9B5] bg-white aspect-square"
                  >
                    <img
                      src={media.url}
                      alt={`Upload ${idx + 1}`}
                    ...
                    />
                    {idx === 0 && (
                      <span className="absolute top-1.5 left-1.5 px-2 py-0.5 rounded-full bg-[#8A6200] text-white font-bold text-[9px] uppercase tracking-wider">
                        Primary
                      </span>
                    )}
                    <button
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#E7D9B5] space-y-4 shadow-xs">
          <div className="flex items-center justify-between border-b border-[#E7D9B5] pb-3">
            <div>
              <h2 className="text-sm font-bold text-[#0F172A] font-serif flex items-center gap-2">
                <Sliders className="w-4 h-4 text-[#8A6200]" /> 4. Dynamic Variants & Category Sets
              </h2>
              <p className="text-[10px] text-[#374151]">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`w-11 h-6 rounded-full transition-colors flex items-center p-0.5 ${
                  hasVariants ? 'bg-[#8A6200] justify-end' : 'bg-stone-300 justify-start'
                }`}
              >
                <div className="w-5 h-5 rounded-full bg-white shadow-xs" />
              </button>
            ...
            <div className="space-y-6 text-xs animate-fade-in">
              ...
              <div className="space-y-3">
                {optionSets.map((os, idx) => (
                  <div
                    key={os.id}
                    className="p-4 rounded-3xl bg-white border border-[#E7D9B5] space-y-2"
                  >
                    <div className="flex items-center justify-between">
                    ...
                    {OPTION_NAME_SUGGESTIONS[os.name] && (
                      <div className="pt-1.5 space-y-1">
                        <span className="text-[10px] font-semibold text-[#6B4D00] block">
                    ...
                    <div className="flex flex-wrap gap-1.5 pt-1">
                      {os.values.map((v, vIdx) => (
                        <span
                          key={vIdx}
                          className="px-2.5 py-0.5 rounded-full bg-white border border-[#A87A00] text-[#8A6200] text-[10px] font-bold shadow-xs flex items-center gap-1"
                        >
                          <span>{v}</span>
                          <button
                            type="button"
                ...
                {optionSets.length < 3 && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-2xl bg-[#FFFDF5] hover:bg-[#F8E8BD] border border-[#DCC78B] text-[#6B4D00] font-bold transition text-xs"
                  >
              ...
              {variantMatrix.length > 0 && (
                <div className="space-y-2 pt-2">
                  ...
                  <div className="overflow-x-auto rounded-3xl border border-[#E7D9B5] bg-white">
                    <table className="w-full text-left text-xs border-collapse">
                      <thead>
                        <tr className="border-b border-[#E7D9B5] bg-[#FFE4E6]/60 text-[#6B4D00] uppercase text-[10px] font-bold">
                      ...
                      <tbody className="divide-y divide-[#E7D9B5]/60 text-[#0F172A]">
                        {variantMatrix.map((vRow, vIdx) => (
                          <tr key={vRow.id} className="hover:bg-[#FFF3CE]/40 transition">
                            ...
                            <td className="py-2.5 px-3">
                              <input
                                ...
                                className="px-2.5 py-1 bg-white border border-[#E7D9B5] rounded-xl text-[#0F172A] font-mono text-[11px] focus:outline-none focus:border-[#A87A00] w-44"
                              />
                            </td>
                            <td className="py-2.5 px-3 text-right">
                              <input
                                ...
                                className="px-2.5 py-1 bg-white border border-[#E7D9B5] rounded-xl text-emerald-800 font-mono font-bold text-[11px] text-right focus:outline-none focus:border-[#A87A00] w-28"
                              />
                            </td>
                            <td className="py-2.5 px-3 text-center">
                              <input
                                ...
                                className="px-2.5 py-1 bg-white border border-[#E7D9B5] rounded-xl text-[#0F172A] font-mono font-bold text-[11px] text-center focus:outline-none focus:border-[#A87A00] w-20"
                              />
                            </td>
                          </tr>
                        ))}
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#E7D9B5] space-y-4 shadow-xs">
          <div className="flex items-center justify-between border-b border-[#E7D9B5] pb-3">
            <h2 className="text-sm font-bold text-[#0F172A] font-serif flex items-center gap-2">
              <Layers className="w-4 h-4 text-[#8A6200]" /> 5. Inventory Tracking & Audience
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] font-mono font-bold focus:outline-none focus:border-[#A87A00]"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-[#E7D9B5] rounded-2xl text-[#0F172A] font-mono font-bold focus:outline-none focus:border-[#A87A00] disabled:opacity-60"
              />
        ...
        <div className="p-6 rounded-3xl bg-white border border-[#E7D9B5] space-y-4 shadow-xs">
          <div className="flex items-center justify-between border-b border-[#E7D9B5] pb-3">
            <h2 className="text-sm font-bold text-[#0F172A] font-serif flex items-center gap-2">
              <Globe className="w-4 h-4 text-[#8A6200]" /> 6. Publishing Sales Channels
            </h2>
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-3xl border flex flex-col items-center justify-center gap-2 transition ${
                    isSelected
                      ? 'bg-[#FFFDF5] border-[#DCC78B] text-[#6B4D00] font-bold shadow-xs'
                      : 'bg-white border-[#E7D9B5] text-[#374151] hover:bg-[#FFFDF5]'
                  }`}
                >
                  <Icon className="w-5 h-5 text-[#8A6200]" />
        ...
        <div className="p-4 rounded-3xl bg-white border border-[#E7D9B5] flex items-center justify-between shadow-xs">
          <Link
            to="/admin/products"
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/admin/products"
              className="px-4 py-2 rounded-2xl bg-white border border-[#E7D9B5] text-xs font-bold text-[#6B4D00] hover:bg-[#FFF3CE] transition"
            >
              Cancel
            </Link>
            <button
