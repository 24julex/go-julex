        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full accent-[#8A6200] cursor-pointer h-2 bg-[#FBF0D2] dark:bg-obsidian-800 rounded-lg"
            />
          </div>
      ...
      previewGraphic: (
        ...
        >
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              { id: 'blush', name: 'Pastel Blush', color: '#FFFDF5', border: '#DCC78B', text: '#6B4D00' },
              ...
              <button
                ...
                className={'p-3 rounded-2xl border text-center transition cursor-pointer ' + (previewTheme === th.id ? 'ring-2 ring-offset-1 ring-[#8A6200] font-bold shadow-xs' : 'opacity-70 hover:opacity-100')}
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 text-base">
            <button
              ...
              className={'p-3 rounded-xl border text-center font-bold transition cursor-pointer flex items-center justify-center gap-1.5 ' + (activeInvoiceFormat === 'A4' ? 'bg-[#8A6200] text-white border-[#8A6200]' : 'bg-[#FDFAEE] dark:bg-obsidian-800 border-[#EFE2BC] text-[#475569] dark:text-slate-400')}
            >
            ...
            <button
              ...
              className={'p-3 rounded-xl border text-center font-bold transition cursor-pointer flex items-center justify-center gap-1.5 ' + (activeInvoiceFormat === 'thermal' ? 'bg-[#8A6200] text-white border-[#8A6200]' : 'bg-[#FDFAEE] dark:bg-obsidian-800 border-[#EFE2BC] text-[#475569] dark:text-slate-400')}
            >
        ...
        <div className="relative w-full h-[calc(100vh-73px)] flex items-center justify-center overflow-hidden">
          ...
          <h1 className="font-serif text-[2.75rem] sm:text-6xl lg:text-7xl font-black tracking-tight text-[#0F172A] dark:text-slate-100 leading-tight">
            ...
            <span className="text-[#A87A00] inline-block">
              Keep Sales Free of Platform Commission.
            </span>
          </h1>

          <p className="text-lg sm:text-xl lg:text-2xl text-[#475569] dark:text-slate-400 font-normal max-w-3xl mx-auto leading-relaxed">Create a branded storefront and manage products and orders in one place. GO JULEX charges 0% platform commission; payment provider fees may apply. Store publishing and online payments are being configured.</p>
        </div>
        </div>
        ...
        <div className="relative rounded-3xl overflow-hidden border border-[#EFE2BC] shadow-xl bg-white dark:bg-obsidian-850">
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-5 p-6 sm:p-10 space-y-4 text-left">
              <span className="text-[10px] uppercase tracking-[0.25em] text-[#8A6200] font-bold block">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="px-5 py-3 rounded-xl bg-[#8A6200] hover:bg-[#6B4D00] text-white font-bold text-sm shadow-md transition flex items-center gap-2 cursor-pointer"
                >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••"
                      className="w-full pl-10 pr-3.5 py-2.5 bg-white dark:bg-obsidian-850 border border-[#EFE2BC] rounded-xl text-[#0F172A] dark:text-slate-100 text-lg font-mono font-bold tracking-[0.35em] placeholder:text-slate-400 focus:outline-none focus:border-[#8A6200] focus:ring-2 focus:ring-rose-100 transition"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3.5 py-2.5 bg-white dark:bg-obsidian-850 border border-[#EFE2BC] rounded-xl text-[#0F172A] dark:text-slate-100 text-sm placeholder:text-slate-400 focus:outline-none focus:border-[#8A6200] focus:ring-2 focus:ring-rose-100 font-medium transition"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3.5 py-2.5 bg-white dark:bg-obsidian-850 border border-[#EFE2BC] rounded-xl text-[#0F172A] dark:text-slate-100 text-sm placeholder:text-slate-400 focus:outline-none focus:border-[#8A6200] focus:ring-2 focus:ring-rose-100"
                    />
                  </div>
                </div>
                      ...
                      <>
                        {!otpSent ? (
                          <button
                            ...
                            onClick={sendOtp}
                            disabled={otpBusy}
                            className="px-3 py-1.5 rounded-xl bg-[#FFFDF5] hover:bg-[#F8E8BD] border border-[#DCC78B] text-[#6B4D00] text-[11px] font-bold transition cursor-pointer disabled:opacity-60"
                          >
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center gap-2">
                              <input
                                ...
                                className="w-32 px-3 py-1.5 bg-white border border-[#E7D9B5] rounded-xl font-mono font-bold tracking-widest text-center"
                              />
                              <button
                                type="button"
                                onClick={verifyOtp}
                                disabled={otpBusy}
                                className="px-3 py-1.5 rounded-xl bg-[#8A6200] hover:bg-[#6B4D00] text-white text-[11px] font-bold transition cursor-pointer disabled:opacity-60"
                              >
                                {otpBusy ? 'Checking…' : 'Verify Code'}
                              </button>
                              <button type="button" onClick={sendOtp} disabled={otpBusy} className="text-[10px] font-bold text-stone-500 hover:text-[#6B4D00] cursor-pointer">Resend</button>
                            </div>
