...
export const MerchantsPage = () => {
  ...
  return (
    <div className="space-y-6 text-[#0F172A]">
      ...
      <div className="p-4 rounded-3xl bg-white border border-[#E7D9B5] space-y-3 shadow-xs">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white border border-[#E7D9B5] rounded-2xl text-xs text-[#0F172A] placeholder-stone-400 focus:outline-none focus:border-[#A87A00]"
          />
        </div>
            ...
            <button
              ...
              className={`px-3 py-1 rounded-xl font-semibold text-xs transition ${
                roleFilter === role
                  ...
                  : 'bg-white text-[#6B4D00] hover:bg-[#FFF3CE] border border-[#E7D9B5]'
              }`}
            >
              {role}
            </button>
      ...
      {/* 3. Merchants Table */}
      <div className="bg-white border border-[#E7D9B5] rounded-3xl overflow-hidden shadow-xs">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-[#FFE4E6]/60 border-b border-[#E7D9B5] text-[10px] uppercase font-bold text-[#6B4D00] tracking-wider">
              <tr>
            ...
            <tbody className="divide-y divide-[#E7D9B5]/60 text-[#0F172A]">
              {filteredMerchants.map((merchant) => (
                <tr key={merchant.id} className="hover:bg-[#FFF3CE]/40 transition">
                  {/* Name */}
                  <td className="py-3.5 px-4">
                    <div className="flex items-center gap-2.5">
                      <img
                        ...
                        className="w-8 h-8 rounded-xl object-cover border border-[#E7D9B5] shrink-0 bg-slate-100"
                      />
                  ...
                  <td className="py-3.5 px-4 text-right">
                    <div className="flex items-center justify-end gap-1.5">
                      <button
                        ...
                        className="px-2.5 py-1 rounded-xl bg-[#FFFDF5] hover:bg-[#F8E8BD] border border-[#DCC78B] text-[#6B4D00] text-[10px] font-bold transition flex items-center gap-1"
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-xl bg-white hover:bg-[#FFF3CE] text-[#6B4D00] border border-[#E7D9B5] transition"
