...
// API Routes
app.use('/api/auth', rateLimit({ windowMs: 5 * 60 * 1000, max: 60 }), authRoutes);
app.use('/api/products', productRoutes);
app.use('/api/brands', brandRoutes);
app.use('/api/orders', rateLimit({ windowMs: 5 * 60 * 1000, max: 100 }), orderRoutes);
app.use('/api/uploads', express.static(uploadDir, { immutable: true, maxAge: '30d', fallthrough: false }));
