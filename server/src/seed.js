...
export async function seedDatabase() {
  ...
  // Disposable demo customer for exercising the storefront sign-in flow.
  await prisma.user.upsert({
    where: { email: 'customer@gojulex.com' },
    update: { role: 'USER', name: 'Demo Customer' },
    create: {
  ...
  console.log('✅ Demo Customer created: customer@gojulex.com');
